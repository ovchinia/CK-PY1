class Planken:
    ...
    def cut_planken(self, cut: (int, float)) -> None:
        """
...
class Ticket:
    ...
    def buy_ticket(self, buy: (int, float)) -> bool:
        """
    ...
    def amount_ticket(self, amount: int) -> bool:
        """
...
class ButerbrodKolbasaSir:
    ...
    def amount_ingridients(self, amount_i: int) -> bool:
        """
        Проверяем хватит ли нам ингридиентов на бутерброд с колбасой и сыром.
        :param amount_i:Колиичество ингридиентов.
        Примеры:
        amount_i = ButerbrodKolbasaSir(0, 1, 1, 1)
        amount_i.amount_ingridients(0, 1, 1, 1)
    ...
    def amount_sandwich(self, amount_s: int) -> None:
        """
        Проверяем на сколько бутербродов с колбасой и сыром нам хватит ингридиентов.
        :param amount_s: Количество бутербродов.
        amount_s = ButerbrodKolbasaSir(1, 1, 1, 1)
        amount_i.amount_ingridients(0, 1, 1, 1)
        Если всех ингридиентов хватает, то перезаписываем количество бутербродов.
